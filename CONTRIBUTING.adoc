...
Before contributing code, familiarise yourself with the following guides:

* xref:guides/Development/hack-on-the-trento.adoc[Local Development Setup] — start here to get Trento running on your machine
* xref:guides/Development/testing.adoc[Testing Guide] — how to run and write backend, frontend, and E2E tests
* xref:guides/Development/ci-cd.adoc[CI/CD Pipeline Guide] — understand the GitHub Actions workflows, PR environments, and release process
* xref:guides/Development/environment-variables.adoc[Environment Variables] — full reference for configuration options
* link:hack/README.md[Developer Tools (`hack/`)] — helper scripts for API docs, test scenarios, and flaky test analysis
